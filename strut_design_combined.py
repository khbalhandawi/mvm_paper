...
if __name__ == "__main__":
    ...
    decision_1 = Decision(universe=list(range(60,120+10,10)), variable_type='ENUM', key='decision_1',
    ...
    man.save('strut_fem_1000',folder='strut_fea')

    # man.load('strut_fem_100',folder='strut_fea')
